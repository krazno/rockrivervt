  ...
  return [
    {
      ...
      type: "image" as const,
      tags: [...INGEST_VIS, "group", "summer", "river stones"],
      width: 1024,
      height: 768,
      featured: true,
      homepage: true,
    ...
    },
    {
      ...
      type: "image" as const,
      tags: [...INGEST_VIS, "wellness", "river stones"],
      width: 1024,
      height: 1024,
      featured: true,
      homepage: true,
    ...
    },
    {
      ...
      type: "image" as const,
      tags: [...INGEST_VIS, "summer", "swimming hole"],
      width: 1024,
      height: 1024,
      featured: true,
      homepage: true,
    ...
    },
    {
      ...
      type: "image" as const,
      tags: [...INGEST_VIS, "humor", "river stones"],
      width: 1024,
      height: 1024,
      featured: true,
      homepage: false,
