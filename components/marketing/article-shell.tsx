      ...
      <main className="rr-body pb-20">
        <Container className="py-10 sm:py-12">
          <article className="rr-panel-light mx-auto max-w-3xl px-6 py-8 sm:px-10 sm:py-10">
            <header>
              <p className="text-[10px] font-semibold uppercase tracking-[0.26em] text-[var(--rr-widget-accent)]">
                {eyebrow}
              </p>
            ...
            <div className="mt-8 space-y-8 text-[var(--rr-ink)] [&_a]:font-medium [&_a]:text-[var(--rr-widget-accent)] [&_a]:underline-offset-2 [&_a]:hover:underline [&_h2]:font-heading [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-[var(--rr-ink)] [&_h2]:sm:text-2xl [&_p]:leading-relaxed [&_p]:text-[var(--rr-ink-muted)] [&_ul]:list-disc [&_ul]:space-y-2 [&_ul]:pl-5 [&_ul]:text-[var(--rr-ink-muted)]">
              {children}
            </div>
          </article>
        </Container>
